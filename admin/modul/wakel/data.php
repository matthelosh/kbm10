                ...
                ORDER BY tb_walikelas.id_mkelas DESC");
                        ...
                        <tr>
                            ...
                            <a class="btn btn-danger btn-sm" onclick="return confirm('Yakin Hapus Data ??')" 
                                href="?page=walas&act=del&id=<?= $k['id_walikelas'] ?>">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
               ...
               <div class="form-group">
                ...
                <?php 
                if (isset($_POST['edit'])) {
                    $cek = mysqli_num_rows(mysqli_query($con,"SELECT * FROM tb_walikelas WHERE id_guru='$_POST[wakel]' AND id_walikelas != '$_POST[id]'"));
                    if ($cek > 0) {
                        echo "<script>
                        alert('Guru tersebut sudah menjadi wali kelas!');
                        </script>";
                    } else {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php 
                if (isset($_POST['save'])) {
                    $cek = mysqli_num_rows(mysqli_query($con,"SELECT * FROM tb_walikelas WHERE id_guru='$_POST[wakel]'"));
                    if ($cek > 0) {
                        echo "<script>
                        alert('Guru tersebut sudah menjadi wali kelas!');
                        </script>";
