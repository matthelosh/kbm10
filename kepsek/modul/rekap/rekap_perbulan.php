            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    $qry = mysqli_query($con, "
                        ...
                        JOIN tb_mengajar ON _logabsensi.id_mengajar = tb_mengajar.id_mengajar
                        ...
                        WHERE _logabsensi.id_mengajar = '$idMengajar' 
                        ...
                        <div class="alert alert-warning alert-dismissible mt-2" role="alert">
                            ...
                            <table width="100%" border="1" cellpadding="2" style="border-collapse: collapse;">
                                <tr>
                                    ...
                                    <td colspan="<?= $tglTerakhir; ?>" style="padding: 8px;">PERTEMUAN KE- DAN BULAN : <b style="text-transform: uppercase;"><?= namaBulan($bulanAngka); ?> <?= date('Y', strtotime($tglBulan)); ?></b></td>
                                ...
                                $qryAbsen = mysqli_query($con, "
                                    ...
                                    WHERE MONTH(tgl_absen) = '$bulanAngka' 
                                    AND _logabsensi.id_mengajar = '$idMengajar'
                                ...
                                ?>
                                    <tr bgcolor="<?= $warna; ?>">
                                        ...
                                        ?>
                                            <td align="center" bgcolor="white">
                                                ...
                                                switch ($nilaiKet) {
                                                    ...
                                                    case 'A':
                                                    case 'T':
                                                    case 'C': echo "<b style='color:#D50000;'>A</b>"; break;
                                                    default: echo "";
                                                }
                                                ?>
                                            </td>
                                        ...
                                        <td align="center" style="font-weight: bold;">
                                            <?php
                                            $sakit = mysqli_fetch_array(mysqli_query($con, "
                                                ...
                                                AND ket = 'S'
                                            "));
                                            echo ($sakit['jml']) ? $sakit['jml'] : '-';
                                            ?>
                                        </td>
                                        <td align="center" style="font-weight: bold;">
                                            <?php
                                            $izin = mysqli_fetch_array(mysqli_query($con, "
                                                SELECT COUNT(*) as jml FROM _logabsensi 
                                                WHERE id_siswa = '{$s['id_siswa']}'
                                                AND id_mengajar = '$idMengajar'
                                                AND MONTH(tgl_absen) = '$bulanAngka'
                                                AND ket = 'I'
                                            "));
                                            echo ($izin['jml']) ? $izin['jml'] : '-';
                                            ?>
                                        </td>
                                        <td align="center" style="font-weight: bold;">
                                            <?php
                                            $alpha = mysqli_fetch_array(mysqli_query($con, "
                                                SELECT COUNT(*) as jml FROM _logabsensi 
                                                WHERE id_siswa = '{$s['id_siswa']}'
                                                AND id_mengajar = '$idMengajar'
                                                AND MONTH(tgl_absen) = '$bulanAngka'
